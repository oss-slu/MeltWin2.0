                                       ...
                                       sidebarLayout(
                                         sidebarPanel(
                                           textInput(label = "Enter the Pathlength for each absorbance reading. (Note, they should be separated by commas and have no spaces inbetween.)",
                                                     ...
                                                     inputId = "pathlengths"),
                                           radioButtons(inputId = "molStates",
                                                        label = "Select the molecular state.(Please note that your selection will apply to all samples, beyond just the ones in the current dataset.)",
